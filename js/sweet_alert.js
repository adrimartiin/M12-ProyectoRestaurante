document.addEventListener('DOMContentLoaded', function () {
    ...
    buttons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            const confirmButtonText = action === 'reservar' ? 'Sí, ocupar' : 'Sí, desocupar';
            const successTitle = action === 'reservar' ? 'Mesa reservada' : 'Mesa desocupada';
            const successMessage = action === 'reservar' ? 'La mesa ha sido ocupada con éxito.' : 'La mesa ha sido desocupada con éxito.';
